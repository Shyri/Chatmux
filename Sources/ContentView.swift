...
struct VerticalTabsSidebar: View {
    ...
    private func cmuxSidebarSurfaceKind(for panelType: PanelType) -> CmuxSidebarSurfaceKind {
        ...
        case .extensionBrowser:
            return .unknown
        case .claudeChat, .workspaceTodo, .cloudVMLoading:
            return .unknown
        }
    }
...
struct TabItemView: View, Equatable {
    ...
    var hasClaudeChatRunning: Bool { snapshot.hasClaudeChatRunning }
    var hasClaudeChatNeedsInput: Bool { snapshot.hasClaudeChatNeedsInput }
